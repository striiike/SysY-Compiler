...
void SillyParser::parseGlobalVar(GlobalVariable *glo) const {
...
void SillyParser::parseFunction(Function *func) {
...
void SillyParser::parseInstruction(Instruction *inst) {
...
void SillyParser::parseAllocaInst(AllocaInst *inst) {
	int len;
...
void SillyParser::parseAluInst(AluInst *inst) {
...
void SillyParser::parseBrInst(BrInst *inst) {
	if (inst->jump) {
...
void SillyParser::parseCallInst(CallInst *inst) {
...
void SillyParser::parseGEPInst(GEPInst *inst) {
...
void SillyParser::parseIcmpInst(IcmpInst *inst) {
	auto op1 = inst->getOperand(0), op2 = inst->getOperand(1);
...
void SillyParser::parseLoadInst(LoadInst *inst) {
	auto op1 = inst->getOperand(0);
...
void SillyParser::parseReturnInst(ReturnInst *inst) {
...
void SillyParser::parseStoreInst(StoreInst *inst) {
	auto op1 = inst->getOperand(0), op2 = inst->getOperand(1);
...
void SillyParser::parseZextInst(ZextInst *inst) {
	mipsBuilder->allocate(inst->getOperand(0), $t0);
	mipsBuilder->allocateAndStore(inst, $t0);
}
void SillyParser::parseMoveInst(MoveInst *inst) {
